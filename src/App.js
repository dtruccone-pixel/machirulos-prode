    ...
    return(
      <div style={S.root}>
        ...
        <div style={S.wrap}>
          ...
          {/* Login prompt — si no hay jugador */}
          {!jugador&&(
            <div style={{...S.card,textAlign:"center",padding:20,marginBottom:10}}>
              <p style={{color:MUTED,margin:"0 0 12px",fontSize:14}}>
                Inicia sesion para cargar tus pronosticos
              </p>
              <button style={S.btn(`linear-gradient(90deg,${fase.color},${fase.color}99)`,"#000","none",{padding:"12px 24px",fontSize:14})}
                onClick={()=>setScr("elegirKO")}>⚽ Ingresar</button>
            </div>
          )}

...
export const setPronostico      = (jugador, partidoId, fase, l, v) => post({ action:"setPronostico", jugador, partidoId, fase, l, v });
export const enviarFase         = (jugador, fase)                => post({ action:"enviarFase", jugador, fase });
...
export const setEquiposPartido  = (partidoId, local, vis)        => post({ action:"setEquiposPartido", partidoId, local, vis });
export const desbloquearJugador = (jugador, fase)                => post({ action:"desbloquearJugador", jugador, fase });
export const bloquearJugador    = (jugador, fase)                => post({ action:"bloquearJugador", jugador, fase });
